...
export default function ReportConfigPage() {
  ...
  const savePanel = async () => {
    ...
    else if (!/^\d{4}$/.test(inputNam.trim()))
      errors.nam = "Năm phải là 4 chữ số";
  ...
  const thBase =
    "border-b border-[#e5e7eb] bg-[#f9fafb] px-3.5 py-2.5 text-left text-[13px] font-semibold text-[#374151] whitespace-nowrap";
